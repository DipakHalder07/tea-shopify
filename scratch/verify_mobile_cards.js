...
async function run() {
  ...
  // Scroll to the product cards section on mobile
  ...
  fs.writeFileSync(`${baseDir}/product_cards_mobile_2px_dashed.png`, Buffer.from(snap.data, 'base64'));
  console.log('Saved product_cards_mobile_2px_dashed.png');
